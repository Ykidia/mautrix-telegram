...
if os.path.exists(".git") and shutil.which("git"):
    try:
        ...
        git_revision_url = f"https://github.com/ykidia/mautrix-telegram/commit/{git_revision}"
...
git_tag_url = (
    f"https://github.com/ykidia/mautrix-telegram/releases/tag/{git_tag}" if git_tag else None
)
